        ...
        <Col xs={24} md={18} lg={14}>
          <Typography>
            ...
            <Paragraph>
              ...
              for analyzing e-commerce data, visualizing key metrics, and
              enabling strategic decisions based on the Olist Brazilian dataset.
              It's designed to be fast, insightful, and easy to use.
            </Paragraph>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <Text strong>Responsive Design:</Text> Accessible from desktop
                or mobile.
              </li>
            </ul>
              ...
              <ol className="list-decimal pl-6 space-y-2">
                <li>
                  ...
                  <pre className="bg-gray-100 p-2 rounded mt-1">
                    git clone
                    https://github.com/your-username/olist-dashboard.git
                  </pre>
                </li>
                <li>
            ...
            <Paragraph>
              This application is also hosted on AWS with the following
              services:
